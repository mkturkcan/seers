...
checkpoint_folder = "DeepSeek-R1-Vision-Distill-Qwen-1.5B_google_vit-base-patch16-224"
# Load models
...
if training_config == 'tiny':
    ...
    image_processor, vision_model, vision_hidden_size = vision.get_image_encoder('google/vit-base-patch16-224', device=device, use_peft=True)
